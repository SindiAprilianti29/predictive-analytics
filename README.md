...
- Melihat contoh data dengan df.head()
  ![image](https://github.com/user-attachments/assets/82eb8da3-2332-42a6-a75e-1207aa7ece7f)

- Melihat statistik deskriptif dari data dengan df.describe()
  ![image](https://github.com/user-attachments/assets/8c1b89ed-30db-4eb6-9d2b-e3cf592ef66f)
...
- Menampilkan histogram dan correlation_matrix untuk memahami karakteristik dan hubungan yang ada dalam dataset.
  
  Beberapa fitur memiliki sebaran data distribusi normal, mayoritas datanya berada di sekitar rata-rata. Namun, ada juga fitur yang skewed, seperti anxiety_level yang datanya menjorok ke kiri, menunjukkan bahwa mayoritas orang memiliki anxiety level yang tinggi.
...
Pada tahap ini dilakukan tiga langkah data preparation
- Hapus outlier dengan metode IQR
  Setelah dilakukan penghapusan outlier, hanya tersisa 457 entri data.
- Train test split
